    ...
    public class ChaosMinionEntity extends Monster implements IAnimatable {
        private AnimationFactory factory = new AnimationFactory(this);
    
        public ChaosMinionEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
            super(pEntityType, pLevel);
            this.getAttribute(Attributes.MAX_HEALTH).setBaseValue(60.0f);
            this.setHealth(60.0f); // 초기 체력 설정
        }
